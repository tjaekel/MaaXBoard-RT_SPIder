...
usb_status_t USB_DeviceCdcAcmEvent(void *handle, uint32_t event, void *param)
{
    ...
    switch (eventCode)
    {
        ...
        case kUSB_DeviceClassEventSetConfiguration:
            ...
            {
#if 0
                (void)debug_log("kUSB_DeviceClassEventSetConfiguration, USB_DeviceInitEndpoint fail\r\n");
#endif
            }
            break;
        case kUSB_DeviceClassEventSetInterface:
            ...
            {
#if 0
                (void)debug_log("kUSB_DeviceClassEventSetInterface, USB_DeviceInitEndpoint fail\r\n");
#endif
            }
            break;
                                  ...
                                  class_handle_t *handle)
{
    ...
    {
#if 0
        (void)debug_log("mutex create error!");
#endif
    }
...
usb_status_t USB_DeviceCdcAcmDeinit(class_handle_t handle)
{
    ...
    {
#if 0
        (void)debug_log("mutex destroy error!");
#endif
    }
